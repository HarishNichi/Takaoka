...
export const TempRegisterServices = {
  ...
  registerLineDetails: _registerLineDetails,
  lineLogin: _lineLogin,
  getLineUserList: _getLineUserList,
  sendLineMessage: _sendLineMessage,
  updateLineReadStatus: _updateLineReadStatus,
  lineWebhook: _lineWebhook
};
...
function _registerLineDetails(payload, callBackFun) {
  axios
    .post("/user/registration/line/update", payload)
    .then((response) => {
      callBackFun(response.data);
      toastDisplay(response);
    })
...
function _lineLogin(payload, callBackFun) {
  axios
    .post("/line/login", payload)
    .then((response) => {
      callBackFun(response.data);
    })
    .catch((error) => {
...
function _getLineUserList(payload, callBackFun) {
  axios
    .post("/admin/line/notification/list", payload)
    .then((response) => {
      callBackFun(response.data);
    })
    .catch((error) => {
...
function _sendLineMessage(payload, callBackFun) {
  axios
    .post("/admin/line/send/notification", payload)
    .then((response) => {
      callBackFun(response.data);
      toastDisplay(response)
    })
...
function _updateLineReadStatus(payload,callBackFun) {
  axios
    .post("admin/line/update/read/status", payload) // Adjust key if needed
    .then((res) => {
...
function _lineWebhook(callBackFun) {
  axios
    .post("/line/call/webhook")
    .then((response) => {
      callBackFun(true);
    })
    .catch((error) => {
