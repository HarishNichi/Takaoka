...
const Layout = (props) => {
    ...
    const pageTitles_en = {
        ...
        "/admin/line/history": "Admin - Line History",
        ...
        "/user/register/confirm": "Register Confirmation",
        ...
        "/user/temp-register/confirm": "Temporary Registration Confirmation",
        "/user/temp-person-count": "Temporary Person Count",
    ...
    "/admin/questionnaire/individual": "管理｜個人ごとの個別項目",
     "/admin/push/notification": "管理｜LINE連携避難者一覧",
    "/admin/line/history": "管理｜LINE通知履歴",
