                ...
                <div>
                  <Button
                    buttonProps={{
                      ...
                      severity: "primary",
                      disabled:
                        !showRegisteredEvacuees || evacueesDataList.length <= 0,
                      onClick: () => openDeleteDialog(),
                      ariaLabel: translate(localeJson, "bulk_delete"),
                    }}
