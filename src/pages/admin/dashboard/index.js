...
function AdminDashboard() {
    ...
    const columnsData = [
        { field: 'number', header: translate(localeJson, 'number'), className: "sno_class",headerClassName: "sno_class",
    textAlign: "left",
    alignHeader: "left", },
        ...
        if (response?.success && !_.isEmpty(response.data) && response.data.total > 0) {
            ...
            if (dataOfFirstObj) {
                dataOfFirstObj.map((obj, i) => {
                    let preparedColumnObjToMerge = { field: (locale == "ja" ? obj.name : obj.name_en), header: locale == "ja" ? obj.name : obj.name_en, minWidth: "8rem", headerClassName: "custom-header", textAlign: "center", alignHeader: "center" };
            ...
            data.map((obj, i) => {
                let preparedObj = {
                    ...
                    number_of_evacuees: `${obj.totalPerson + obj.countFamily}${translate(localeJson, 'people')}`,
                   ...
                   // household: `${obj.countFamily}${translate(localeJson, 'household_title')}`,
                    number_of_people_count_only: `${obj.countFamily}${translate(localeJson, 'people')}`,
