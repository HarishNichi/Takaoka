...
export default function AdminQrCodeCreatePage() {
  ...
  const [qrCodeCreateDialogVisible, setQrCodeCreateDialogVisible] =
    useState(false);
  ...
  const schema = Yup.object().shape({
    file: Yup.mixed()
      ...
      .test(
        "record-limit",
        translate(localeJson, "file_max_records_check"),
        async (value) => {
          if (!value) return true; // If no file is selected, the validation passes.
    ...
    name: Yup.string().max(
      25,
      translate(localeJson, "company_name_max_length")
    ),
    project_name: Yup.string().max(
      25,
      translate(localeJson, "project_name_max_length")
    ),
  });

  /* Services */
  const { callExport, callImport, callDelete, callZipDownload } =
    QRCodeCreateServices;
                    ...
                    <div>
                      ...
                      <div className="pb-3">
                        <InputFile
                          ...
                          parentClass={`w-full bg-white ${
                            errors.file && touched.file && "p-invalid "
                          }`}
                        />
                        <div className="">
                          <ValidationError
                      ...
                      <div className="w-full flex lg:flex-row flex-column">
                        <div className="xl:w-5 lg:w-6 w-full">
                          <div className="pb-3">
                            <MultiSelect
                              multiSelectProps={{
                                inputId: "selectedBasicInfoDropdown", // ✅ Add unique input ID
                                ariaLabel: translate(
                                  localeJson,
                                  "qr_output_items"
                                ), // ✅ Aria label
                                labelProps: {
                                  ...
                                  spanText: "",
                                  inputMultiSelectLabelSpanClassName:
                                    " p-error",
                                  htmlFor: "selectedBasicInfoDropdown", // ✅ Associate label
                                },
                                multiSelectClassName:
                                  "xl:w-22rem lg:w-18rem md:w-full w-full h-40",
                                float: false,
                                floatLabelProps: {},
                          ...
                          >
                            <div>
                              <Button
                                buttonProps={{
                                  buttonClass:
                                    "evacuation_button_height import-button",
                                  type: "submit",
                                  import: true,
                                  disabled: disableBtn,
                        ...
                        <div className="xl:w-7 lg:w-6 w-full">
                          <CustomHeader
                            headerClass={"page-header1"}
                            header={translate(localeJson, "imp_notes")}
                          />
                          <div>
                            {/* Full Name */}
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "fullName_header")}：
                              </strong>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "postalCode1_header")}：
                              </strong>
                              <p>
                                {translate(localeJson, "postalCode1_message")}
                              </p>
                            </div>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "postalCode2_header")}：
                              </strong>
                              <p>
                                {translate(localeJson, "postalCode2_message")}
                              </p>
                            </div>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "address_notes_header")}
                                ：
                              </strong>
                              <p>
                                {translate(localeJson, "address_notes_message")}
                              </p>
                            </div>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "phoneNumber_header")}：
                              </strong>
                              <p>
                                {translate(localeJson, "phoneNumber_message")}
                              </p>
                            </div>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "birthDate_header")}：
                              </strong>
                              <p>
                                {translate(localeJson, "birthDate_message")}
                              </p>
                            </div>
                            ...
                            <div className="col-12 flex flex-wrap align-items-baseline">
                              <strong>
                                {translate(localeJson, "gender_notes_header")}：
                              </strong>
                              <p>
                                {translate(localeJson, "gender_notes_message")}
                              </p>
                            </div>
                          </div>
                        </div>
